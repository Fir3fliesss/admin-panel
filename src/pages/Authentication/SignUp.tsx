  ...
  return (
    <>
      <div className="flex dark:bg-slate-900 justify-center items-center h-screen md:px-24 p-4">
        <div
          className="rounded-sm border border-stroke bg-white w-full md:px-24 p-4 shadow-default dark:border-slate-700 dark:bg-slate-800">
            ...
            <div className="w-full border-stroke dark:border-slate-700 xl:w-1/2 xl:border-l-2">
              <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                ...
                <form>
                  ...
                  <button
                    className="flex w-full items-center text-black justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 hover:bg-opacity-50 dark:border-slate-700 dark:bg-slate-700 dark:hover:bg-opacity-50">
                  <span>
                    <svg
                      width="20"
                      height="20"
